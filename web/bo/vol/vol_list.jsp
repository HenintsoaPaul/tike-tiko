...
<section id="liste">
    ...
    <table>
        ...
        <tr>
            ...
            <td><%= vol.getId_ville_depart() %>
            </td>
            <td><%= vol.getId_ville_destination() %>
            </td>
            <td><%= vol.getHeure_depart() %>
            </td>
            <td><%= vol.getHeure_arrivee() %>
            </td>
            <td><%= vol.getPrix_place_business() %>
            </td>
            <td><%= vol.getPrix_place_eco() %>
            </td>
            <td><%= vol.getNb_place_promo_business() %>
            </td>
            <td><%= vol.getNb_place_promo_eco() %>
            </td>
        </tr>
        <% } %>
        </tbody>
